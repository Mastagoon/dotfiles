...
-- floating terminal
map("n", "<leader>q", function() Util.float_term(nil, { cwd = Util.get_root() }) end, { desc = "Terminal (root dir)" })
map("n", "<leader>Q", function() Util.float_term() end, { desc = "Terminal (cwd)" })
...
map('n', 'T', vim.lsp.buf.hover, {desc="Hover"})
